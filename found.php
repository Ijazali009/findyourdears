...
<head>
    ...
    <title>Found Persons - Find Your Dears</title>
...
<body>
    ...
    <header class="header">
        <h1>Found Persons</h1>
        <p>Help us reunite found individuals with their families</p>
    </header>
    ...
    <div class="found-grid">
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                echo '<div class="found-card">';
                echo '<img src="' . htmlspecialchars($row['photo_url']) . '" alt="Found person photo">';
                echo '<h3>' . htmlspecialchars($row['name']) . '</h3>';
                echo '<p>' . htmlspecialchars($row['description']) . '</p>';
                echo '<p><strong>Found At:</strong> ' . htmlspecialchars($row['location']) . '</p>';
            ...
            echo '<p style="text-align: center; grid-column: 1/-1;">No found persons reported yet.</p>';
        }
        ?>
    </div>
